  ...
  function CoupleSidebar({ isOpen, onClose }) {
    const location = useLocation();

    const menuItems = [
      { path: "/", icon: <IoMdHome  size={22} />, label: "HomePage" },
      { path: "/couples/dashboard", icon: <MdDashboard  size={20} />, label: "Dashboard" },
      { path: "edit-profile", icon: <CgProfile  size={20} />, label: "Edit Profile" },
      { path: "Message", icon: <FiMessageSquare size={20} />, label: "Message" },
      { path: "Calendar", icon: <FaCalendarAlt size={20} />, label: "Calender" },
      { path: "bookings",  icon: <FaRegCalendarCheck size={20} />, label: "Booking" },
      { path: "WhishList",  icon: <FaRegCalendarCheck size={20} />, label: "Whishlist" },
      { path: "ChangePassword", icon: <FaLock size={20} />, label: "Change Password" },
    ];
